...
## MAIN ####
directory <- "//nas-csdm.rgu.ac.uk/csdm-H/Students/17/1715818/Desktop/Project/Code/DynamicOptimizationProblems/results/testRKEDA/tai100_10_0(0-0.025)/"
setwd(directory)
...
optimums <- read.csv("~/Desktop/Project/Code/DynamicOptimizationProblems/data/optimums/optimum.csv")
...
write.csv(df.pm, paste0("//nas-csdm.rgu.ac.uk/csdm-H/Students/17/1715818/Desktop/Project/Code/DynamicOptimizationProblems/performanceMeasure/",dir.name,".csv") ,row.names = TRUE)
closeAllConnections()
